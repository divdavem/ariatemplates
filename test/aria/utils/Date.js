...
Aria.classDefinition({
    ...
    $prototype : {
        ...
        testCutYearOption : function () {
            var ariaDateUtil = aria.utils.Date;
            this.assertEquals(ariaDateUtil.format(ariaDateUtil.interpretMonthAndYear("0345", false, {cutYear: 90}),"dd/MM/yyyy"), "01/03/2045");
            this.assertEquals(ariaDateUtil.format(ariaDateUtil.interpretMonthAndYear("0345", false, {cutYear: 46}),"dd/MM/yyyy"), "01/03/2045");
            this.assertEquals(ariaDateUtil.format(ariaDateUtil.interpretMonthAndYear("0345", false, {cutYear: 45}),"dd/MM/yyyy"), "01/03/2045");
            this.assertEquals(ariaDateUtil.format(ariaDateUtil.interpretMonthAndYear("0345", false, {cutYear: 44}),"dd/MM/yyyy"), "01/03/1945");
            this.assertEquals(ariaDateUtil.format(ariaDateUtil.interpretMonthAndYear("0345", false, {cutYear: 10}),"dd/MM/yyyy"), "01/03/1945");
            ...
            this.assertEquals(ariaDateUtil.format(ariaDateUtil.interpretDateAndMonth("010345", true, {cutYear: 90}), "dd/MM/yyyy"), "01/03/2045");
            this.assertEquals(ariaDateUtil.format(ariaDateUtil.interpretDateAndMonth("010345", true, {cutYear: 46}), "dd/MM/yyyy"), "01/03/2045");
            this.assertEquals(ariaDateUtil.format(ariaDateUtil.interpretDateAndMonth("010345", true, {cutYear: 45}), "dd/MM/yyyy"), "01/03/2045");
            this.assertEquals(ariaDateUtil.format(ariaDateUtil.interpretDateAndMonth("010345", true, {cutYear: 44}), "dd/MM/yyyy"), "01/03/1945");
            this.assertEquals(ariaDateUtil.format(ariaDateUtil.interpretDateAndMonth("010345", true, {cutYear: 10}), "dd/MM/yyyy"), "01/03/1945");
