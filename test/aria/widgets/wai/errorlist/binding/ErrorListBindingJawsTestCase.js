    ...
    $prototype : {
        ...
        runTemplateTest : function () {
            ...
            this.execute([
                ...
                ["waitForJawsToSay","Error The first name is a required field using a mandatory validator dot  The last name is a required field using a mandatory validator dot  The phone number is a required field using a mandatory validator dot  The email is a required field using a mandatory validator."],
                ["type",null,"[down]"],
                ["waitForJawsToSay","list of 4 items"],
                ["type",null,"[down]"],
                ["waitForJawsToSay","bullet Link The first name is a required field using a mandatory validator."],
                ["type",null,"[down]"],
                ["waitForJawsToSay","bullet Link The last name is a required field using a mandatory validator."],
                ["type",null,"[space]"],
                ["waitForJawsToSay","Space"],
