...
var applyCutYear = function (year, options) {
    if (year < 100) {
        var cutYear = (options || {}).cutYear || ariaUtilsDate._cutYear;
    ...
    $prototype : {
        ...
        interpret : function (entryStr, options) {
            ...
            if (!dateOptions.isMonthYear) {
                return this.interpretDateAndMonth(entry, dateBeforeMonth, dateOptions);
            } else {
                return this.interpretMonthAndYear(entry, dateOptions.yearBeforeMonth, dateOptions);
            }
         ...
         * @return {Date}
         */
        interpretDateAndMonth : function (dateStr, dateBeforeMonth, options) {
         ...
         * @return {Date}
         */
        interpretMonthAndYear : function (dateStr, yearBeforeMonth, options) {
