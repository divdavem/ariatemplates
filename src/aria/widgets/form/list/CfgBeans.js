    ...
    $beans : {
        "ListModel" : {
            ...
            $properties : {
                ...
                "listItemDomIdPrefix" : {
                    $type : "json:String",
                    $description : "Prefix to prepend to the index to compute the id (to be passed to the {id .../} statement) of each list item. It is required to put ids on all list items only if accessibility is true.",
                    $default : "myItem"
                }
            }
        },
