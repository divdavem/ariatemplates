...
{Template {
    ...
    {macro renderItem(item, itemIdx)}
        ...
        <a {if data.accessibility}{id data.listItemDomIdPrefix + itemIdx/} role="option"{/if} ref="javascript:void(0)" class="${className}" data-itemIdx="${itemIdx}" onclick="return false;">
            {if ! item.label}
                &nbsp;
